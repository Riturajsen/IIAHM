...
<html lang="en">
 ...
 <div class="container mt-5 p-3">
       ...
       <tr>
            ...
            <td><?=$row['institute'];?></td>
            <td><?=$row['modified'];?></td>
            <td><a href="callAction.php?id=<?=$row['id']?>&name=<?=$username?>&teleId=<?=$userId?>" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-outbound-fill" viewBox="0 0 16 16">
